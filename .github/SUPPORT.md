...
[GitHub Discussions](https://github.com/signalxjs/router/discussions). It keeps
...
- [Report a bug](https://github.com/signalxjs/router/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/signalxjs/router/issues/new?template=feature_request.yml)

Before filing, please:

- Check existing [issues](https://github.com/signalxjs/router/issues?q=is%3Aissue) and
  [discussions](https://github.com/signalxjs/router/discussions) to avoid duplicates.
